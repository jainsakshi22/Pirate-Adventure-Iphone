...
-(NSArray *) tiles
{
    ...
    //    CCTile *test = [[CCTile alloc] init];
    //    test.story = @"Story to test adding mutable object in nonmutable array";
    
    NSMutableArray *firstColumn = [[NSMutableArray alloc] init];    //Mutable Array
    [firstColumn addObject:tile1];
    [firstColumn addObject:tile2];
    [firstColumn addObject:tile3];
    //  [firstColumn addObject:test];
    ...
    NSArray *secondColumn = [[NSArray alloc] initWithObjects:tile4, tile5, tile6, nil]; //Non mutable Array
...
-(CCCharacter *)character
{
    ...
    character.health = 100;     //Why we didnot set up damage initially?
